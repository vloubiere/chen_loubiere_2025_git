...
Installation guide:
  ...
  - Custom functions were wrapped into a R package that can be installed using devtools: `devtools::install_github("vloubiere/vlite@7c4a7fe08b2527952f9b8b25263f7c2c0821d274")`
