...
peaks <- peaks[signalValue>3 & qValue>5]
...
cols <- c("heart", "limb", "forebrain", "midbrain", "hindbrain", "neural-tube", "shared", "allPeaks")
...
vl_heatmap(
  ...
  pdf.file = "pdf/1_tests_review/overlap_VISTA_overlapped_ATAC_peaks.pdf",
  pdf.cell.size = .3,
  pdf.close = FALSE
)
